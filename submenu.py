...
SUBMENUS_ETAPA_1 = [
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    ...
                    "públicos. Representa entre el 12% y el 20% del PIB en la mayoria "
                    "de paises (OCDE), lo que la convierte en un area critica para la "
                    ...
                    "Colombia, la plataforma SECOP (Sistema Electronico de "
                    "Contratación Pública) centraliza los procesos de contratación "
                    "estatal, generando grandes volumenes de datos susceptibles de "
                    "análisis."
                ),
            },
            {
                ...
                "contenido": (
                    "Existe una asimetria entre el volumen de datos abiertos de "
                    "contratación pública disponibles y su uso efectivo para "
                    "identificar patrones de riesgo, ineficiencia o irregularidad en "
                    "la asignacion de recursos públicos. Muchas entidades "
                    "territoriales no cuentan con herramientas analiticas que les "
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "indices de transparencia (Open Contracting Partnership, Banco "
                    "Mundial - Procurement) y comparación entre paises en eficiencia "
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    ...
                    "Gobernacion de Cundinamarca y sus dependencias. Proveedores y "
                    "contratistas registrados en el Registro snico de Proponentes "
                    "(RUP). A nivel global, Open Contracting Partnership (OCP), "
                    "responsable del estandar OCDS, y el Banco Mundial, a traves de "
                    "su iniciativa Benchmarking Public Procurement, que compara la "
                    "regulacion y desempeño de la contratación pública entre paises."
                ),
            },
            {
                "tipo": "enlaces",
                ...
                "lista": [
                    ...
                    {"texto": "Registro snico de Proponentes (RUP) - Camara de Comercio", "url": "https://www.rues.org.co/RUP"},
                    {"texto": "Gobernacion de Cundinamarca", "url": "https://www.cundinamarca.gov.co/"},
            ...
            },
            {
                ...
                "contenido": (
                    "Las variables se agrupan según el tipo de patron de riesgo/fraude "
                    ...
                    "el portal de datos.gov.co, seccion 'Información Adicional' del "
                    ...
                    "Grupo 2 - Uso atipico de la modalidad de contratación: "
                    ...
                    "registrada.\n\n"
                    "Grupo 3 - Anomalias de tiempo y de valor: 'precio_base' y "
                    ...
                    "'fecha_de_apertura_efectiva', 'fecha_adjudicacion', 'duración' y "
                    ...
                    "adjudicados a proveedores fuera de su región de forma atipica.\n\n"
                    "Variables de trazabilidad y filtrado (no son indicador de "
                    "riesgo por si mismas, pero son obligatorias para poder unir, "
                    ...
                    "Variables descartadas por bajo valor analitico para este "
            ...
            {
                "tipo": "texto",
                "subtitulo": "Período de análisis",
                "contenido": (
                    "Se tomará como período de análisis 2020-2025 para SECOP II, por "
                    "ser el rango en el que la plataforma transaccional ya cuenta con "
                    "una adopcion amplia y estable por parte de las entidades "
                    "estatales, lo cual reduce el sesgo de subregistro propio de los "
                    "primeros anos de la plataforma (lanzada en 2016). Para los "
                    "indicadores globales de referencia se usará la ultima "
            ...
            },
            {
                ...
                "contenido": (
                    "Global: muestra de paises incluidos en OCDS/Benchmarking Public "
                    "Procurement, usados como referencia comparativa.\n"
                    "Nacional: todo el territorio colombiano (32 departamentos y "
                    "Bogota D.C.), según registro de SECOP I y II.\n"
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "publicado por una entidad estatal colombiana. Se trabajara con "
                    "granularidad a nivel de proceso individual (no agregados "
                    "mensuales o anuales), lo que permite luego construir agregados "
                    "propios por entidad, sector, modalidad, departamento o período "
            ...
            },
            {
                ...
                "contenido": (
                    "Para permitir la comparación entre niveles se estandarizaran al "
                    "menos las siguientes variables comunes: (1) monto contratado, "
                    "normalizado a USD o como porcentaje del gasto total del período, "
                    "para comparar magnitudes entre país/departamento; (2) sector u "
                    "objeto del contrato, mapeado a una clasificacion comun de tipo "
                    "CPV/CPC; (3) año/período de referencia, para alinear series de "
    ...
    },
    {
        ...
        "bloques": [
            {
                "tipo": "texto",
                "subtitulo": "Criterio de clasificacion",
                "contenido": (
            ...
            },
            {
                ...
                "filas": [
                    ...
                    ["Institucion responsable", "Colombia Compra Eficiente (ANCP-CCE)", "Colombia Compra Eficiente (ANCP-CCE)", "MinTIC / ANCP-CCE"],
                    ...
                    ["Período disponible", "Histórico por proceso, variable según entidad", "2016 (lanzamiento SECOP II) a la fecha", "Depende de cada conjunto de datos publicado"],
                    ["Formato", "Consulta web individual (HTML por proceso)", "CSV / JSON via API Socrata (SODA)", "CSV / JSON / API Socrata"],
                    ...
                    ["N.º aprox. de registros", "1 (por consulta); se usa como verificación puntual, no como fuente masiva", "Del orden de varios millones de procesos acumulados desde 2016 (cifra exacta a validar al momento de la descarga)", "Cientos de conjuntos de datos de contratación disponibles"],
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "manipulados, aunque no elimina errores de digitacion de cada "
                    ...
                    "del catálogo de datos.gov.co permite ademas verificar y "
            ...
            },
            {
                ...
                "filas": [
                    ["Nombre", "Contratación a un Clic", "Planes Anuales de Adquisiciones (PAA) de la Gobernacion"],
                    ["Institucion responsable", "Gobernacion de Cundinamarca", "Gobernacion de Cundinamarca (dependencias del sector central)"],
                    ["URL", "https://www.cundinamarca.gov.co/web/contratación", "https://www.cundinamarca.gov.co/web/transparencia/planeacion/planes-anuales-de-adquisiciones"],
                    ["Tipo de fuente", "Terciaria", "Primaria"],
                    ["Cobertura geográfica", "Departamento de Cundinamarca", "Departamento de Cundinamarca"],
                    ["Período disponible", "Vigencias publicadas por la Gobernacion (ultimos anos)", "Vigencia fiscal en curso y anteriores publicadas"],
                    ["Formato", "Tablero web / enlaces a SECOP", "PDF / Excel"],
                    ["Método de adquisición", "Consulta en linea del tablero de contratación departamental", "Descarga directa de los documentos publicados"],
                    ["N.º aprox. de registros", "Variable según vigencia y dependencia consultada", "Decenas a cientos de items de adquisición planeada por vigencia"],
                    ...
                    ["Restricciones de uso", "Uso público, información de caracter informativo/consulta", "Uso público bajo Ley 1712 de 2014"],
                    ["Enlace directo de consulta", "https://www.cundinamarca.gov.co/web/contratación", "https://www.cundinamarca.gov.co/web/transparencia/planeacion/planes-anuales-de-adquisiciones"],
                ],
            },
            {
                "tipo": "enlaces",
                ...
                "lista": [
                    {"texto": "Gobernacion de Cundinamarca - Portal institucional", "url": "https://www.cundinamarca.gov.co/"},
                    {"texto": "Contratación a un Clic - Cundinamarca", "url": "https://www.cundinamarca.gov.co/web/contratación"},
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "porque rodea a Bogota y agrupa municipios con capacidades "
                    ...
                    "directamente por la Gobernacion, aunque Contratación a un Clic "
            ...
            },
            {
                ...
                "filas": [
                    ...
                    ["Institucion responsable", "Open Contracting Partnership (OCP)", "Banco Mundial (World Bank Group)"],
                    ["URL", "https://standard.open-contracting.org/latest/en/", "https://bpp.worldbank.org/"],
                    ["Tipo de fuente", "Secundaria", "Secundaria"],
                    ["Cobertura geográfica", "Multiples paises que publican en formato OCDS", "Mas de 180 economías"],
                    ["Período disponible", "Depende de cada país publicador", "Reportes periodicos (ediciones anuales/bienales)"],
                    ...
                    ["N.º aprox. de registros", "Variable por país (miles a millones de procesos publicados en formato abierto)", "1 indicador por país/edicion, agregable por año"],
                    ["Variables disponibles", "Comprador, proveedor, valor, fechas, items, modalidad (esquema comun OCDS)", "?ndice de regulacion, tiempo de tramite, transparencia, uso de e-procurement, por país"],
                    ["Fecha de consulta", "Agosto de 2026", "Agosto de 2026"],
                    ["Restricciones de uso", "Datos abiertos, licencia Open Data Commons", "Uso público con atribucion al Banco Mundial"],
            ...
            },
            {
                ...
                "lista": [
                    ...
                    {"texto": "Open Contracting Data Standard (OCDS) - documentacion del esquema", "url": "https://standard.open-contracting.org/latest/en/"},
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "referencias estandar de facto para comparar contratación "
                    "pública entre paises, lo que permite responder la pregunta "
                    ...
                    "Banco Mundial) con metodologias públicas y auditables. "
                    "Actualidad: OCDS depende de la frecuencia de publicación de "
                    "cada país; Benchmarking Public Procurement se actualiza por "
                    "ediciones periodicas del Banco Mundial. Cobertura: amplia a "
                    "nivel de paises, pero con una granularidad mucho menor "
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    ...
                    "realiza mediante descarga via API de SECOP II "
                    "(https://www.datos.gov.co/resource/p6dx-8zbt.json), filtrando "
                    "por departamento y fecha, integrando despues las variables "
                    "comparativas de nivel global y regional descritas en la seccion "
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "regional se le anade una columna de 'nivel_comparacion' que "
                    "permite unir, en el análisis, un proceso puntual de SECOP con el "
                    "indicador global o departamental del mismo período."
                ),
            },
            {
                "tipo": "tabla",
                ...
                "filas": [
                    ...
                    ["CO1.PCCNTR.002", "Bogota D.C.", "Licitación pública", "3000000000", "3200000000", "8", "5", "2023-05-10", "2023-07-02", "800987654-2", "Nacional", "https://community.secop.gov.co/Public/Tendering/OpportunityDetail/Index?noticeUID=CO1.PCCNTR.002"],
                    ["CO1.PCCNTR.003", "Antioquia", "Mínima cuantia", "12000000", "12500000", "3", "2", "2024-11-05", "2024-11-20", "901234567-3", "Nacional", "https://community.secop.gov.co/Public/Tendering/OpportunityDetail/Index?noticeUID=CO1.PCCNTR.003"],
                ],
            },
            {
                "tipo": "texto",
            ...
            },
            {
                ...
                "contenido": (
                    ...
                    "numericas ('precio_base', 'valor_total_adjudicacion', "
                    "'proveedores_invitados', 'proveedores_unicos_con'), variables "
                    "categoricas ('departamento_entidad', 'modalidad_de_contratacion', "
                    ...
                    "ademas del indicador derivado 'nivel_comparacion' "
            ...
            },
            {
                ...
                "contenido": (
                    "La estructura del dataset se diseño pensando en las técnicas que "
                    "se aplicaran en etapas posteriores: 'ratio_valor_adjudicado_base' "
                    ...
                    "'fecha_adjudicacion' junto con 'duración' permiten análisis de "
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    ...
                    "(entidad, ubicacion, modalidad, valor, fechas, proveedor y "
            ...
            },
            {
                ...
                "encabezados": ["Variable (campo API)", "Tipo de dato", "Descripción", "Unidad / dominio", "Grupo de riesgo al que aporta", "Fuente / documentacion"],
                "filas": [
                    ["entidad", "Texto", "Nombre de la entidad que pública el proceso", "Catálogo de entidades públicas", "Trazabilidad / Grupo 4", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["nit_entidad", "Texto (identificador)", "NIT de la entidad que público el proceso", "NIT colombiano", "Trazabilidad / Grupo 4", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["departamento_entidad", "Categórica / geográfica", "Departamento en el cual esta registrada la entidad", "32 departamentos + Bogota D.C.", "Trazabilidad / Grupo 4 (comparar con departamento_proveedor)", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["ciudad_entidad", "Categórica / geográfica", "Ciudad en la cual esta registrada la entidad", "Catálogo DIVIPOLA", "Grupo 4", "https://geoportal.dane.gov.co/laboratorio/codificacion-divipola/"],
                    ...
                    ["id_del_proceso", "Texto (identificador)", "Identificador único del proceso, generado por la plataforma", "Código alfanumerico SECOP", "Trazabilidad / llave primaria del registro", "https://community.secop.gov.co/"],
                    ["modalidad_de_contratacion", "Categórica", "Modalidad de seleccion bajo la cual se desarrolla el proceso", "Licitación pública, contratación directa, mínima cuantia, seleccion abreviada, concurso de meritos, otras", "Grupo 2", "https://www.colombiacompra.gov.co/"],
                    ["justificaci_n_modalidad_de", "Texto", "Justificación de la modalidad de seleccion elegida", "Texto libre / puede estar vacio", "Grupo 2 (ausencia de justificación = señal de riesgo)", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["tipo_de_contrato", "Categórica", "Tipo de contrato definido para el proceso", "Catálogo SECOP (obra, consultoria, suministro, etc.)", "Grupo 2", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ...
                    ["fecha_adjudicacion", "Temporal (fecha)", "Fecha en la que se adjudico el proceso al proveedor seleccionado", "AAAA-MM-DD", "Grupo 3 (días entre publicación y adjudicación)", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["duración", "Numérica (entero)", "Duración estimada del proceso de compra", "Según 'unidad_de_duracion'", "Grupo 3", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["unidad_de_duracion", "Categórica", "Unidad que aplica a la duración estimada", "Dias, meses, anos", "Grupo 3", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ...
                    ["adjudicado", "Categórica (Si/No)", "Determina si el proceso fue adjudicado", "Si / No", "Trazabilidad - filtrado", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["nombre_del_adjudicador", "Texto", "Nombre del usuario que ejecuto la accion de adjudicación", "Texto libre", "Grupo 4 (reincidencia adjudicador-proveedor)", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ...
                    ["departamento_proveedor", "Categórica / geográfica", "Departamento en el que esta registrado el proveedor adjudicado", "32 departamentos + Bogota D.C.", "Grupo 4 (comparar con departamento_entidad)", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["ciudad_proveedor", "Categórica / geográfica", "Ciudad en la que esta registrado el proveedor adjudicado", "Catálogo DIVIPOLA", "Grupo 4", "https://geoportal.dane.gov.co/laboratorio/codificacion-divipola/"],
                    ["urlproceso", "URL", "Enlace al proceso de compra en la plataforma", "URL valida", "Trazabilidad - verificación puntual", "https://community.secop.gov.co/"],
                ],
            },
            {
                "tipo": "tabla",
                "subtitulo": "Variables derivadas para el análisis de riesgo (calculadas por el equipo, no vienen directas de la API)",
                "encabezados": ["Variable derivada", "Formula / regla", "Interpretacion de riesgo"],
                "filas": [
                    ...
                    ["contratacion_directa_sin_justificacion", "modalidad_de_contratacion = 'Contratación directa' y 'justificaci_n_modalidad_de' vacio", "Señal de incumplimiento documental y posible riesgo de direccionamiento"],
                    ["proveedor_fuera_de_region", "departamento_proveedor distinto a departamento_entidad, en montos bajos que no ameritan proveedor foraneo", "Posible indicio de relación previa entidad-proveedor no explicada por especializacion técnica"],
                ],
            },
            {
                "tipo": "tabla",
                ...
                "filas": [
                    ...
                    ["anio_periodo", "Temporal (año)", "Ano de referencia usado para unir un proceso de SECOP con un indicador global/regional del mismo período", "AAAA", "Derivada de fecha_de_publicacion_del", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["indicador_apertura_global", "Numérica (indice)", "Indicador de apertura/competencia comparable a nivel país", "Escala del indicador de Benchmarking Public Procurement", "Banco Mundial - Benchmarking Public Procurement", "https://bpp.worldbank.org/en/data/exploreeconomies"],
                ],
            },
            {
                "tipo": "enlaces",
                "subtitulo": "Documentacion oficial y diccionarios de datos consultados",
                "lista": [
                    ...
                    {"texto": "Codificacion DIVIPOLA (DANE) - departamentos y municipios", "url": "https://geoportal.dane.gov.co/laboratorio/codificacion-divipola/"},
                    {"texto": "Catálogo UNSPSC (Naciones Unidas)", "url": "https://www.ungm.org/Public/UNSPSC"},
                    {"texto": "Registro snico de Proponentes (RUP)", "url": "https://www.rues.org.co/RUP"},
                    {"texto": "Colombia Compra Eficiente - normatividad y guias de modalidades de seleccion", "url": "https://www.colombiacompra.gov.co/"},
                ],
            },
        ],
    },
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    ...
                    "porcentajes exactos se calcularan sobre el archivo consolidado "
                    ...
                    "caracteristicos de datos administrativos de contratación "
                    ...
                    "una misma entidad (sin estandarizar mayusculas/tildes), y "
            ...
            },
            {
                ...
                "encabezados": ["Variable", "Tipo de problema", "Problema detectado", "Causa probable", "Accion propuesta", "Fuente dónde se verifico"],
                "filas": [
                    ...
                    ["id_del_proceso", "Registros duplicados", "Registros duplicados por adenda o modificacion", "SECOP II pública una nueva versión del proceso ante cada modificacion", "Conservar solo la versión más reciente por id_del_proceso", "https://community.secop.gov.co/"],
                    ["entidad", "Inconsistencia de formato", "Inconsistencia de formato (mayusculas, tildes, abreviaturas)", "Digitacion manual por parte de cada entidad", "Normalizar texto (minusculas, sin tildes) y usar catálogo oficial de entidades", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["valor_total_adjudicacion", "Valores fuera de dominio", "Valores en cero, negativos o atipicamente altos frente al resto de su categoría UNSPSC", "Procesos sin oferta economica registrada o errores de digitacion", "Marcar como valor no disponible en lugar de eliminar; revisar outliers antes de excluir", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["proveedores_unicos_con", "Valores fuera de dominio", "Valores negativos o mayores a 'proveedores_invitados'", "Errores de captura en el modulo de SECOP II", "Validar contra el rango logico [0, proveedores_invitados] y marcar como inconsistente si no cumple", "https://www.datos.gov.co/Gastos-Gubernamentales/SECOP-II-Procesos-de-Contrataci-n/p6dx-8zbt"],
                    ["departamento / municipio", "Diferencias de formato", "Diferencias de codificacion entre SECOP y DIVIPOLA (DANE)", "Uso de nombres de texto libre en vez de codigos estandarizados", "Cruzar contra el catálogo DIVIPOLA para unificar nombres", "https://geoportal.dane.gov.co/laboratorio/codificacion-divipola/"],
                    ["moneda / unidad monetaria", "Diferencias de formato", "Diferencia de unidad entre datos nacionales (COP) y globales (USD)", "Cada fuente reporta en su moneda local o de referencia", "Convertir a una unidad comun usando tasa de cambio del período correspondiente", "https://www.banrep.gov.co/es/estadisticas/trm"],
                    ["nivel_comparacion (integración SECOP-OCDS/Banco Mundial)", "Problema de integración entre fuentes", "Granularidad distinta: SECOP reporta a nivel de proceso individual, mientras OCDS y Benchmarking Public Procurement reportan agregados por país/año", "Diseño metodologico distinto entre fuentes administrativas y fuentes de benchmarking internacional", "Unir por año y país como agregado, no intentar llevar el indicador global al nivel de proceso individual", "https://bpp.worldbank.org/"],
                    ["fecha_de_publicacion_del / fecha_adjudicacion (integración SECOP-Contratación a un Clic)", "Problema de integración entre fuentes", "No siempre existe una llave exacta entre un proceso de SECOP y su referencia en el tablero departamental", "El tablero regional enlaza a SECOP pero no siempre expone el mismo identificador de proceso", "Integrar por combinacion de entidad + fecha + valor aproximado cuando no exista el id_del_proceso exacto, documentando el nivel de certeza del cruce", "https://www.cundinamarca.gov.co/web/contratación"],
                    ["cobertura por entidad", "Sesgo", "Posible sesgo de subregistro en municipios pequenos", "Menor capacidad institucional para publicar oportunamente en SECOP II", "Documentar el sesgo como limitación y evitar comparar municipios con baja tasa de publicación sin ajuste", "https://www.colombiacompra.gov.co/"],
                ],
            },
            {
                "tipo": "texto",
                ...
                "contenido": (
                    "Se conservara una copia sin modificar de cada archivo fuente "
                    ...
                    "Contratación a un Clic (https://www.cundinamarca.gov.co/web/contratación), "
        ...
        "bloques": [
            {
                ...
                "contenido": (
                    "Cobertura temporal: SECOP II inicio en 2016 y su adopcion por "
                    "parte de las entidades fue gradual, por lo que los primeros anos "
                    "tienen menor representatividad; se prioriza 2020-2025.\n"
                    "Cobertura geográfica: no todas las entidades territoriales "
                    "publican con la misma disciplina en SECOP II; algunas pequenas "
                    "alcaldias aún dependen de SECOP I o de publicación fisica, lo "
                    ...
                    "de proceso, por lo que la comparación global se hara "
                    "principalmente a nivel de indicadores agregados, no de "
                    "registros individuales.\n"
                    "Recursos técnicos: el volumen histórico de SECOP II es de gran "
                    "tamano, por lo que la descarga y el procesamiento se realizan "
                    "mediante muestreo filtrado por departamento y período, no sobre "
                    "la totalidad historica de la plataforma."
                ),
            },
            {
                "tipo": "texto",
                ...
                "contenido": (
                    "El dataset incluye identificacion de proveedores (NIT, razon "
                    "social) y, en algunos casos, de contratistas personas naturales, "
                    "lo cual constituye un dato de caracter público según la Ley 1712 "
                    ...
                    "información únicamente con fines academicos y analiticos, (2) "
                    "evitar publicar conclusiones que senalen individualmente a una "
                    "persona natural o entidad como responsable de una irregularidad "
                    "sin el debido soporte estadístico, y (3) documentar que la "
                    "presencia de patrones atipicos (por ejemplo, alta concentración "
                    "de contratos en un proveedor) es un indicio para análisis "
                    "posterior y no una acusacion de corrupción o ilegalidad."
                ),
            },
            {
                "tipo": "enlaces",
